...
for pp in listOfPatient:
    ...
    # for j in range(y):
    #     slice = img_fdata[j, :, :]
    #     matplotlib.image.imsave(f'D:/Projekty/Git projekt/mastery-machine-learning/nii_data/I/mask/{pp}imgY{j}.png',
    #                             slice, cmap=cm.gray)
    for k in range(x):
        slice = img_fdata[:, :, k]
        matplotlib.image.imsave(f'D:/Projekty/Git projekt/mastery-machine-learning/nii_data/I/mask/{pp}imgX{k}.png',
                                slice, cmap=cm.gray)
